 ...
 *  Single File concatenated by Grunt Concatenate on 04-01-2017
 */
  ...
  SCRIB.PolylineGraphEmbedder = (function() {
    ...
    PolylineGraphEmbedder.prototype._loadPolyline = function(polyline) {
      ...
      for (i = k = 0, ref1 = len - 1; k < ref1; i = k += 1) {
        this._lines_initial.push(new SCRIB.Line(i + offset, i + offset + 1, this._points));
      }
      ...
      if (polyline.isClosed()) {
        this._lines_initial.push(new SCRIB.Line(len - 1 + offset, 0 + offset, this._points));
      }
    };
    ...
    PolylineGraphEmbedder.prototype._sort_outgoing_edges_by_angle = function() {
      var iter, outgoing_edges, results, vert_data;
      iter = this._graph.verticesBegin();
      results = [];
      while (iter.hasNext()) {
        vert_data = iter.next().data;
        outgoing_edges = vert_data.outgoing_edges;
        results.push(this._sort_outgoing_edges(outgoing_edges));
      }
      return results;
    };
    ...
    PolylineGraphEmbedder.prototype._sort_outgoing_edges = function(outgoing_edges) {
      ...
      for (j = 0, len1 = outgoin_edges.length; j < len1; j++) {
        edge = outgoin_edges[j];
        hedge_out = edge;
      ...
      for (i = k = 0, ref = len; k < ref; i = k += 1) {
        for (i2 = l = ref1 = i - 1; ref1 <= 0 ? l <= 0 : l >= 0; i2 = ref1 <= 0 ? ++l : --l) {
          i1 = i2 + 1;
...
(function() {
  ...
  SCRIB.Face_Info = (function() {
    function Face_Info() {
      this.holes = [];
      this.points = [];
      this.polyline = new SCRIB.Polyline(true);
  ...
  SCRIB.PolylineGraphPostProcessor = (function() {
    ...
    PolylineGraphPostProcessor.prototype.clipAllTails = function() {
      ...
      for (index = j = 0, ref = len; 0 <= ref ? j < ref : j > ref; index = 0 <= ref ? ++j : --j) {
        ...
        clipped_face = this.clipTails(unclipped_face);
    ...
    PolylineGraphPostProcessor.prototype.clipTails = function(input) {
