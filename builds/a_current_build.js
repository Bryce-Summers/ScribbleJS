...
(function() {
  ...
  SCRIB.PolylineGraphPostProcessor = (function() {
    ...
    PolylineGraphPostProcessor.prototype._generateBVH = function() {
      this._graph;
      this._facebvh = null;
      return this._edgebvh = null;
    };
    ...
    PolylineGraphPostProcessor.prototype.eraseEdgesInCircle = function(circle) {
      if (!this._edgebvh) {
        return this._generateBVH();
      }
    };
