/*
 * Click Line Embedding Controller.
 * Moved here by Bryce Summers on 4.4.2017
 *
 * Logic for a simple polyline drawing tool based on mouse clicks
 * that is then embedded into a HalfEdgeGraph using a 
 * SCRIB.PolylinePostProcessor object.
 */

function Controller_clickLine(postProcessor, graphics)
{
...
Controller_clickLine.prototype =
{
    setActive(isActive)
    {
