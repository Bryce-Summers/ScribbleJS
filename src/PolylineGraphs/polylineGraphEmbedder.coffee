...
class SCRIB.PolylineGraphEmbedder
    ...
    # () -> SCRIB.Faace
    _newFace: () ->
        return SCRIB.PolylineGraphEmbedder.newFace(@_graph)

    # () -> SCRIB.Edge
    _newEdge: () ->
        return SCRIB.PolylineGraphEmbedder.newEdge(@_graph)        

    # () -> SCRIB.Halfedge
    _newHalfedge: () ->
        return SCRIB.PolylineGraphEmbedder.newHalfedge(@_graph)

    _newVertex: () ->
        return SCRIB.PolylineGraphEmbedder.newVertex(@_graph)
